    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tb Pasien Add</h3>
            </div>
            <?php echo form_open('tb_pasien/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="no_hp_wali" value="<?php echo $this->input->post('no_hp_wali'); ?>" class="form-control" id="no_hp_wali" />
						</div>
					</div>
				</div>
			</div>
